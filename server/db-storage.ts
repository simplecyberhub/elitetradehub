...
export class DbStorage implements IStorage {
  ...
  // Asset operations (additional methods)
  ...
  // Trader operations (additional methods)
  ...
  // Copy relationship operations (additional methods)
  ...
  // Trade operations (additional methods)
  ...
  // Investment plan operations (additional methods)
  ...
  // Investment operations (additional methods)
  ...
  // KYC document operations (additional methods)
  ...
  // Watchlist operations (additional methods)
